...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < M; i++) {                                       // Loop to create edges.
            ...
            WeightedDirectedEdge e2 = new WeightedDirectedEdge(to, from, weight);   // We add an edge two-times with each being opposite directions because it should have been an Undirected Grpah.
